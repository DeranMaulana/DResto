  ...
  <a class="navbar-brand" href="#">
    ...
    <div class="collapse navbar-collapse" id="navbarText">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="menu_selesai.php">Selesai</a>
        </li>
      </ul>
...
if (!$conn) {
  ...
  if (!isset($_GET['cari'])) {
    $query = mysqli_query($conn, "SELECT DISTINCT transaksi.* FROM transaksi JOIN meja ON transaksi.no_meja = meja.no_meja JOIN detail_transaksi ON transaksi.kode_transaksi = detail_transaksi.kode_transaksi WHERE meja.status='Terisi' AND transaksi.id_pegawai IS NULL AND detail_transaksi.status = 'Selesai'");
...
<form method="POST" action="proses.php">
  <tr>
    ...
    <td class="text-center">
      ...
      <a href="detail_pesanan_selesai.php?kode_transaksi=<?= $dt['kode_transaksi']; ?>" class="btn btn-warning btn-sm">Detail Pesanan</a>
