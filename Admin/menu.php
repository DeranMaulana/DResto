    ...
    ?>
      <tr>
        ...
        <td class="text-center">
          ...
          <button data-id="<?= $dt['kode_menu']; ?>" class="btn btn-danger btn-sm btn-hapus">Hapus</button>
        </td>
      </tr>
    <?php endwhile; ?>
  </tbody>
...
<script>
  ...
  hapusButtons.forEach(function (button) {
    button.addEventListener('click', function (event) {
      ...
      var confirmed = confirm('Apakah Anda yakin ingin menghapus data dengan Kode Menu ' + id + '?');

      // If the user confirms, delete the data
      if (confirmed) {
        // Redirect to the hapus_pegawai.php script with the id parameter
        window.location.href = 'hapus_menu.php?kode_menu=' + id;
      }
    });
  });
</script>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Ubah Data Menu</h1>
      ...
      <div class="modal-body">
        <table>
          ...
          <tr>
            <td>Nama Menu </td>
            <td> </td>
            <td><input type="text" class="form-control" name="nama_menu"></td>
          </tr>
          <tr>
            <td>Kategori </td>
            <td> </td>
...
ubahButtons.forEach(function (button) {
  button.addEventListener('click', function () {
    ...
    var hargaInput = document.querySelector('#exampleModal tr:nth-child(4) input[type="number"]');
